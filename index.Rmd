...
```{r powerful-caterpillar, fig.show='hold', out.width="60%", echo=FALSE, fig.align = 'right'}
...
```{r paco, fig.show='hold', out.width="79%", echo=FALSE, fig.align = 'right'}

knitr::include_graphics('assets/img/paco.png')
```
...
```{r cophy-sim, fig.show='hold', out.width="94%", echo=FALSE, fig.align = 'right'}

library(cophy)

# simulate host tree
set.seed(36830)
htree <- rphylo_H(tmax = 5, lambda = 0.6, mu = 0.1)

# simulate parasite evolution on host tree & visualize
set.seed(83843)
cophy1 <-rcophylo(beta = 0.5, gamma = 0.06, nu = 0.1, HTree=htree)
plot(cophy1)
```
