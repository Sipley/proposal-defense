...
> - <b>Host "escape":</b> <br>parasite extinction
> - <b>Parasite "escape": </b> <br>host-shift
...
- Escape-and-radiate: <br>events coupled with <br>cladogenetic events

<img src="assets/img/dec.png" style="position:absolute; 
float:left; 
right:0px; 
bottom:20px;" width="83%">

<div style="position: absolute; bottom: 18em; left: 5em; font-weight: bold; color: #fff; font-size: 11px;">
<p style="font-size: 20px"; align="right">Braga et al (2020, 2021)<br>Hardy (2016)<br>Kaczvinsky & Hardy (2020)</p>
</div>
...
## Discrete biogeography: Predictions

- More cladogenetic events correctly inferred under escape-and-radiate
- Host-repertoire evolution higher under escape-and-radiate
...
Host enter accelerated rate class after successful "escape" event
...
float:left; 
right:10px; 
bottom:15px;" width="77%">

<div style="position: absolute; top: 5em; right: 5em; font-weight: bold; color: #fff; font-size: 11px;">
...
Diversification models that do not account for unmeasured traits are inappropriat to assess relationships between mutualism and ant diversification
...
## Models of diversification: Predictions

SSE models have low power to detect trait-dependent extinction

SSE models accurately infer changes in rate classes with greater certainty for host phylogenies that evolve under escape-and-radiate than parasite phylogenies
...
Of DEC, GeoSSE, and GeoHiSSE, expect GeoHiSSE to reconstruct coevolution under escape-and-radiate most accurately 
